...
def connectome_beat_glide(rand=0, stim0=2.89, sigma=0, sigma_LR = 0.1, sigmaD = 0, sigmaL = 0, sigmaP =0, sigmaW = 0,
    ...
    tmax += 1000 # add 1000 ms to give time for neurons to settle.  This initial 1000 ms is not used in the data analysis
    nmax = int(tmax/dt) 
    
    ## Declare Neuron Types

    L_MN = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP),b=0.01*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-65*gauss(1, sigmaP), vt=-58*gauss(1, sigmaP), k=0.5*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i*gauss(1, sigma),y=-1) for i in range(nMN)]
    R_MN = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP),b=0.01*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-65*gauss(1, sigmaP), vt=-58*gauss(1, sigmaP), k=0.5*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i*gauss(1, sigma),y=1) for i in range(nMN)]

    L_dI6 = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=-1) for i in range(ndI6)]
    R_dI6 = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=1) for i in range(ndI6)]

    L_V0v = [ Izhikevich_9P(a=0.01*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=2*gauss(1, sigmaP), vmax=8*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=-1) for i in range(nV0v)]
    R_V0v = [ Izhikevich_9P(a=0.01*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=2*gauss(1, sigmaP), vmax=8*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=1) for i in range(nV0v)]

    L_V2a = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=-1) for i in range(nV2a)]
    R_V2a = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i*gauss(1, sigma),y=1) for i in range(nV2a)]
    
    L_V1 = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=7.1+1.6*i*gauss(1, sigma),y=-1) for i in range(nV1)]
    R_V1 = [ Izhikevich_9P(a=0.1*gauss(1, sigmaP),b=0.002*gauss(1, sigmaP),c=-55*gauss(1, sigmaP), d=4*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-54*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 10*gauss(1, sigmaP), dt=dt, x=7.1+1.6*i*gauss(1, sigma),y=1) for i in range(nV1)]
   ...
   #LEFT
    ...
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<LD_MN_MN[k,l]< 4.5*gauss(1, sigmaL)  ):    
                LGap_MN_MN[k,l] = MN_MN_gap_weight*gauss(1, sigmaW)
            else:
                LGap_MN_MN[k,l] = 0.0
    ...
    for k in range (0, ndI6):
        for l in range (0, ndI6):
            if (0.2<LD_dI6_dI6[k,l]< 3.5*gauss(1, sigmaL)  ):    
                LGap_dI6_dI6[k,l] = dI6_dI6_gap_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nV0v):
        for l in range (0, nV0v):
            if (0.2<LD_V0v_V0v[k,l]< 3.5*gauss(1, sigmaL)  ):    
                LGap_V0v_V0v[k,l] = V0v_V0v_gap_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<LD_V2a_V2a[k,l]< 3.5*gauss(1, sigmaL)  ):    
                LGap_V2a_V2a[k,l] = V2a_V2a_gap_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0.2<LD_V2a_MN[k,l]< 3.5*gauss(1, sigmaL)  ):    
                LGap_V2a_MN[k,l] = V2a_MN_gap_weight*gauss(1, sigmaW)
            else:
                LGap_V2a_MN[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, ndI6):
            if (L_dI6[l].x-1.5*gauss(1, sigmaL)  <L_MN[k].x< L_dI6[l].x + 1.5 *gauss(1, sigmaL)  ):    
                LGap_MN_dI6[k,l] = MN_dI6_gap_weight*gauss(1, sigmaW)
            else:
                LGap_MN_dI6[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nV0v):
            if (L_V0v[l].x-1.5*gauss(1, sigmaL)  <L_MN[k].x< L_V0v[l].x + 1.5*gauss(1, sigmaL)  ):    
                LGap_MN_V0v[k,l] = MN_V0v_gap_weight *gauss(1, sigmaW)
            else:
                LGap_MN_V0v[k,l] = 0.0
                
    #chem syn
    V2a_V2a_syn_weight = 0.3 # 0.25 
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<LD_V2a_V2a[k,l]<10*gauss(1, sigmaL)  and L_V2a[k].x < L_V2a[l].x): #the second condition is because the connection is descending
                LW_V2a_V2a[k,l] = V2a_V2a_syn_weight*gauss(1, sigmaW)
            else:
                LW_V2a_V2a[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0<LD_V2a_MN[k,l]<10*gauss(1, sigmaL)  and L_V2a[k].x < L_MN[l].x) or (0.2<LD_V2a_MN[k,l]<4*gauss(1, sigmaL)  and L_V2a[k].x > L_MN[l].x): #the second condition is because the connection is descending and short ascending branch, used to be 0<LD_V2a_MN[k,l]<10
                LW_V2a_MN[k,l] = V2a_MN_syn_weight*gauss(1, sigmaW)
            else:
                LW_V2a_MN[k,l] = 0.0

    V2a_dI6_syn_weight = 0.5 # 0.3       
    for k in range (0, nV2a):
        for l in range (0, ndI6):
            if (0<LD_V2a_dI6[k,l]<10*gauss(1, sigmaL)  and L_V2a[k].x < L_dI6[l].x): #the second condition is because the connection is descending
                LW_V2a_dI6[k,l] = V2a_dI6_syn_weight*gauss(1, sigmaW) 
            else:
                LW_V2a_dI6[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nV1):
            if (0<LD_V2a_V1[k,l]<10*gauss(1, sigmaL)  and L_V2a[k].x < L_V1[l].x):   #the second condition is because the connection is descending
                LW_V2a_V1[k,l] = V2a_V1_syn_weight *gauss(1, sigmaW) 
            else:
                LW_V2a_V1[k,l] = 0.0

    V2a_V0v_syn_weight = 0.3 # 0.25  
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0<LD_V2a_V0v[k,l]<10*gauss(1, sigmaL)  and L_V2a[k].x < L_V0v[l].x) or (0.2<LD_V2a_V0v[k,l]<4*gauss(1, sigmaL)  and L_V2a[k].x > L_V0v[l].x):    #the second condition is because the connection is descending and short ascending
                LW_V2a_V0v[k,l] = V2a_V0v_syn_weight*gauss(1, sigmaW) 
            else:
                LW_V2a_V0v[k,l] = 0.0                
    ...
    for k in range (0, nV1):
        for l in range (0, nMN):
            if (0<LD_V1_MN[k,l]<4.0*gauss(1, sigmaL)  and L_MN[l].x < L_V1[k].x):    #the second condition is because the connection is ascending
                LW_V1_MN[k,l] = V1_MN_syn_weight*gauss(1, sigmaW) 
            else:
                LW_V1_MN[k,l] = 0.0
    ...
    for k in range (0, nV1):
        for l in range (0, nV2a):
            if (0<LD_V2a_V1[l,k]<4.0*gauss(1, sigmaL)  and L_V2a[l].x < L_V1[k].x):    #the second condition is because the connection is ascending
                LW_V1_V2a[k,l] = V1_V2a_syn_weight*gauss(1, sigmaW) 
            else:
                LW_V1_V2a[k,l] = 0.0
    ...
    for k in range (0, nV1):
        for l in range (0, nV0v):
            if (0<LD_V1_V0v[k,l]<4.0*gauss(1, sigmaL)  and L_V0v[l].x < L_V1[k].x):    #the second condition is because the connection is ascending
                LW_V1_V0v[k,l] = V1_V0v_syn_weight*gauss(1, sigmaW)  
            else:
                LW_V1_V0v[k,l] = 0.0
    ...
    for k in range (0, nV1):
        for l in range (0, ndI6):
            if (0<LD_V1_dI6[k,l]<4.0*gauss(1, sigmaL)  and L_dI6[l].x < L_V1[k].x):    #the second condition is because the connection is ascending
                LW_V1_dI6[k,l] = V1_dI6_syn_weight*gauss(1, sigmaW)  
            else:
                LW_V1_dI6[k,l] = 0.0
    ...
    for k in range (0, ndI6):
        for l in range (0, nMN):
            if (0<LD_dI6_MN[k,l]<5.0*gauss(1, sigmaL)  and L_dI6[k].x < R_MN[l].x) or (0.2<LD_dI6_MN[k,l]<2.0*gauss(1, sigmaL)  and L_dI6[k].x > R_MN[l].x):   #because contralateral and bifurcating
                LW_dI6_MN[k,l] = dI6_MN_syn_weight*gauss(1, sigmaW)  
            else:
                LW_dI6_MN[k,l] = 0.0
    ...
    for k in range (0, ndI6):
        for l in range (0, nV2a):
            if (0<LD_dI6_V2a[k,l]<5.0*gauss(1, sigmaL)  and L_dI6[k].x < R_V2a[l].x) or (0.2<LD_dI6_V2a[k,l]<2.0*gauss(1, sigmaL)  and L_dI6[k].x > R_V2a[l].x):     #because contralateral  and bifurcating
                LW_dI6_V2a[k,l] = dI6_V2a_syn_weight*gauss(1, sigmaW)
            else:
                LW_dI6_V2a[k,l] = 0.0
    ...
    for k in range (0, ndI6):
        for l in range (0, ndI6):
            if (0<LD_dI6_dI6[k,l]<5.0*gauss(1, sigmaL)  and L_dI6[k].x < R_dI6[l].x) or (0.2<LD_dI6_dI6[k,l]<2.0*gauss(1, sigmaL)  and L_dI6[k].x > R_dI6[l].x):     #because contralateral  and bifurcating
                LW_dI6_dI6[k,l] = dI6_dI6_syn_weight*gauss(1, sigmaW)*gauss(1, sigma_LR)
            else:
                LW_dI6_dI6[k,l] = 0.0
    ...
    for k in range (0, nV0v):
        for l in range (0, nV2a):
            if (0<LD_V0v_V2a[k,l]<5.0*gauss(1, sigmaL)  and L_V0v[k].x < R_V2a[l].x) or (0.2<LD_V0v_V2a[k,l]<2.0*gauss(1, sigmaL)  and L_V0v[k].x > R_V2a[l].x): #because contralateral and bifurcating
                LW_V0v_V2a[k,l] = V0v_V2a_syn_weight*gauss(1, sigmaW) 
            else:
                LW_V0v_V2a[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<RD_MN_MN[k,l]< 4.5*gauss(1, sigmaL)  ):    
                RGap_MN_MN[k,l] =  MN_MN_gap_weight*gauss(1, sigmaW)  
            else:
                RGap_MN_MN[k,l] = 0.0
                
    for k in range (0, ndI6):
        for l in range (0, ndI6):
            if (0.2<RD_dI6_dI6[k,l]< 3.5*gauss(1, sigmaL)  ):    
                RGap_dI6_dI6[k,l] = dI6_dI6_gap_weight*gauss(1, sigmaW)  
            else:
                RGap_dI6_dI6[k,l] = 0.0
                
    for k in range (0, nV0v):
        for l in range (0, nV0v):
            if (0.2<RD_V0v_V0v[k,l]< 3.5*gauss(1, sigmaL)  ):    
                RGap_V0v_V0v[k,l] = V0v_V0v_gap_weight*gauss(1, sigmaW) 
            else:
                RGap_V0v_V0v[k,l] = 0.0
                              
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<RD_V2a_V2a[k,l]< 3.5*gauss(1, sigmaL)  ):    
                RGap_V2a_V2a[k,l] = V2a_V2a_gap_weight*gauss(1, sigmaW) 
            else:
                RGap_V2a_V2a[k,l] = 0.0
                
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0.2<RD_V2a_MN[k,l]< 3.5*gauss(1, sigmaL)  ):    
                RGap_V2a_MN[k,l] =  V2a_MN_gap_weight*gauss(1, sigmaW) 
            else:
                RGap_V2a_MN[k,l] = 0.0
                
    for k in range (0, nMN):
        for l in range (0, ndI6):
            if (R_dI6[l].x-1.5*gauss(1, sigmaL) <R_MN[k].x< R_dI6[l].x + 1.5*gauss(1, sigmaL)  ):    
                RGap_MN_dI6[k,l] =  MN_dI6_gap_weight*gauss(1, sigmaW) 
            else:
                RGap_MN_dI6[k,l] = 0.0
                
    for k in range (0, nMN):
        for l in range (0, nV0v):
            if (R_V0v[l].x-1.5*gauss(1, sigmaL)  <R_MN[k].x< R_V0v[l].x + 1.5*gauss(1, sigmaL)  ):    
                RGap_MN_V0v[k,l] =  MN_V0v_gap_weight*gauss(1, sigmaW) 
            else:
                RGap_MN_V0v[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<RD_V2a_V2a[k,l]<10*gauss(1, sigmaL)  and R_V2a[k].x < R_V2a[l].x): #the second condition is because the connection is descending
                RW_V2a_V2a[k,l] =  V2a_V2a_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V2a_V2a[k,l] = 0.0
    
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0<RD_V2a_MN[k,l]<10*gauss(1, sigmaL)  and R_V2a[k].x < R_MN[l].x) or (0.2<RD_V2a_MN[k,l]<4*gauss(1, sigmaL)  and R_V2a[k].x > R_MN[l].x): #the second condition is because the connection is descending and short ascending branch
                RW_V2a_MN[k,l] =  V2a_MN_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V2a_MN[k,l] = 0.0
                  
    for k in range (0, nV2a):
        for l in range (0, ndI6):
            if (0<RD_V2a_dI6[k,l]<10*gauss(1, sigmaL)  and R_V2a[k].x < R_dI6[l].x): #the second condition is because the connection is descending and short ascending branch
                RW_V2a_dI6[k,l] =  V2a_dI6_syn_weight *gauss(1, sigmaW) 
            else:
                RW_V2a_dI6[k,l] = 0.0
                
    for k in range (0, nV2a):
        for l in range (0, nV1):
            if (0<RD_V2a_V1[k,l]<10*gauss(1, sigmaL)  and R_V2a[k].x < R_V1[l].x):    #the second condition is because the connection is descending
                RW_V2a_V1[k,l] =  V2a_V1_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V2a_V1[k,l] = 0.0
                
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0<RD_V2a_V0v[k,l]<10*gauss(1, sigmaL)  and R_V2a[k].x < R_V0v[l].x) or (0.2<RD_V2a_V0v[k,l]<4*gauss(1, sigmaL)  and R_V2a[k].x > R_V0v[l].x):    #the second condition is because the connection is descending and short ascending branch
                RW_V2a_V0v[k,l] =  V2a_V0v_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V2a_V0v[k,l] = 0.0   

    for k in range (0, nV1):
        for l in range (0, nMN):
            if (0<RD_V1_MN[k,l]<4.0*gauss(1, sigmaL)  and R_MN[l].x < R_V1[k].x):    #the second condition is because the connection is ascending
                RW_V1_MN[k,l] = V1_MN_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V1_MN[k,l] = 0.0

    for k in range (0, nV1):
        for l in range (0, nV2a):
            if (0<RD_V2a_V1[l,k]<4.0*gauss(1, sigmaL)  and R_V2a[l].x < R_V1[k].x):    #the second condition is because the connection is ascending
                RW_V1_V2a[k,l] =  V1_V2a_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V1_V2a[k,l] = 0.0

    for k in range (0, nV1):
        for l in range (0, ndI6):
            if (0<RD_V1_dI6[k,l]<4.0*gauss(1, sigmaL)  and R_dI6[l].x < R_V1[k].x):    #the second condition is because the connection is ascending
                RW_V1_dI6[k,l] = V1_dI6_syn_weight *gauss(1, sigmaW) 
            else:
                RW_V1_dI6[k,l] = 0.0    
                
    for k in range (0, nV1):
        for l in range (0, nV0v):
            if (0<RD_V1_V0v[k,l]<4.0*gauss(1, sigmaL)  and R_V0v[l].x < R_V1[k].x):    #the second condition is because the connection is ascending
                RW_V1_V0v[k,l] = V1_V0v_syn_weight*gauss(1, sigmaW)  
            else:
                RW_V1_V0v[k,l] = 0.0
                
    for k in range (0, ndI6):
        for l in range (0, nMN):
            if (0<RD_dI6_MN[k,l]<5.0*gauss(1, sigmaL)  and R_dI6[k].x < L_MN[l].x) or (0.2<RD_dI6_MN[k,l]<2.0*gauss(1, sigmaL)  and R_dI6[k].x > L_MN[l].x):   #because contralateral
                RW_dI6_MN[k,l] = dI6_MN_syn_weight*gauss(1, sigmaW) 
            else:
                RW_dI6_MN[k,l] = 0.0
                
    for k in range (0, ndI6):
        for l in range (0, nV2a):
            if (0<RD_dI6_V2a[k,l]<5.0*gauss(1, sigmaL)  and R_dI6[k].x < L_V2a[l].x) or (0.2<RD_dI6_V2a[k,l]<2.0*gauss(1, sigmaL)  and R_dI6[k].x > L_V2a[l].x): #because contralateral
                RW_dI6_V2a[k,l] = dI6_V2a_syn_weight *gauss(1, sigmaW) 
            else:
                RW_dI6_V2a[k,l] = 0.0

    for k in range (0, ndI6):
        for l in range (0, ndI6):
            if (0<RD_dI6_dI6[k,l]<5.0*gauss(1, sigmaL)  and R_dI6[k].x < L_dI6[l].x) or (0.2<RD_dI6_dI6[k,l]<2.0*gauss(1, sigmaL)  and R_dI6[k].x > L_dI6[l].x):     #because contralateral
                RW_dI6_dI6[k,l] = dI6_dI6_syn_weight *gauss(1, sigmaW)*gauss(1, sigma_LR) 
            else:
                RW_dI6_dI6[k,l] = 0.0

    for k in range (0, nV0v):
        for l in range (0, nV2a):
            if (0<RD_V0v_V2a[k,l]<5.0*gauss(1, sigmaL)  and R_V0v[k].x < L_V2a[l].x) or (0.2<RD_V0v_V2a[k,l]<2.0*gauss(1, sigmaL)  and R_V0v[k].x > L_V2a[l].x): #because contralateral and bifurcating
                RW_V0v_V2a[k,l] = V0v_V2a_syn_weight*gauss(1, sigmaW) 
            else:
                RW_V0v_V2a[k,l] = 0.0        
    ...
    for k in range (0, nMN):
        for l in range (0, nMuscle):
            if (R_Muscle[l].x-1<R_MN[k].x< R_Muscle[l].x+1):         #it is segmental
                RW_MN_Muscle[k,l] = MN_Muscle_syn_weight*gauss(1, sigmaW)  
            else:
    ...
    #Remove the initial 1000 ms of the simulation
    VLMNnew = VLMN[:,10000:]
    VRMNnew = VRMN[:,10000:]
    
    VLdI6new = VLdI6[:,10000:]
    VRdI6new = VRdI6[:,10000:]
    
    VLV0vnew = VLV0v[:,10000:]
    VRV0vnew = VRV0v[:,10000:]
    
    VLV2anew = VLV2a[:,10000:]
    VRV2anew = VRV2a[:,10000:]
    
    VLV1new = VLV1[:,10000:]
    VRV1new = VRV1[:,10000:]
    
    VLMusclenew = VLMuscle[:,10000:]
    VRMusclenew = VRMuscle[:,10000:]
    
    Timenew = Time[10000:]-Time[10000:][0]
    
    return (VLMNnew, VRMNnew), (VLdI6new, VRdI6new), (VLV0vnew, VRV0vnew), (VLV2anew, VRV2anew), (VLV1new, VRV1new), (VLMusclenew, VRMusclenew), Timenew, (L_MN, R_MN), (L_dI6, R_dI6), (L_V0v, R_V0v), (L_V2a, R_V2a), (L_V1, R_V1)
