...
class Double_coil_with_gap_chem_sigma(Double_coil_base):

    def __init__(self, dt = 0.1, stim0 = 8, sigma_gap = 0, sigma_chem = 0, E_glu = 0, E_gly = -70,
                  cv = 0.55, nIC = 5, nMN = 10, nV0d = 10, nV0v = 10, nV2a = 10, nMuscle = 10):
        super().__init__(dt, stim0, sigma_gap, E_glu, E_gly,
                  cv, nIC, nMN, nV0d, nV0v, nV2a, nMuscle)
        self.sigma_gap = sigma_gap
        self.sigma_chem = sigma_chem
