...
from Beat_and_glide_30_Somites import Beat_and_glide_30_Somites

class Beat_and_glide_30_Somites_dI6_KO(Beat_and_glide_30_Somites):

    __tdI6KOstart = None #calculated at init
    __tdI6KOend = None #calculated at init
    _tshutoff = None #calculated before the mainLoop
    ...
    def setTimeParameters(self, tmax_ms = 10000, tshutoff_ms = 50, tskip_ms = 1000, dt = 0.1, tdI6KOstart_ms = 6000, tdI6KOend_ms = 11000):
        ...
        self._tshutoff = self.gettShutOff() #this is set before the mainLoop to prevent a function call everytime it is used
