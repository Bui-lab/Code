    ...
    for t in range (0, nmax):
        ...
        for k in range (0, nIC):
            if t < 500: #Synaptic currents are shut off for the first 50 ms of the sims to let initial conditions subside
                ...
                IsynL = sum(RSyn_V0v_IC[nIC*l+k,0]*LW_V0v_IC[l,k] for l in range (0, nV0v))*0 + sum(RSyn_V0d_IC[nIC*l+k,0]*LW_V0d_IC[l,k] for l in range (0, nV0d))
                IsynR = sum(LSyn_V0v_IC[nIC*l+k,0]*RW_V0v_IC[l,k] for l in range (0, nV0v))*0 + sum(LSyn_V0d_IC[nIC*l+k,0]*RW_V0d_IC[l,k] for l in range (0, nV0d))
        ...
        for k in range (0, nV0v):
            if t < 500: #Synaptic currents are shut off for the first 50 ms of the sims to let initial conditions subside
                ...
                IsynL = sum(LSyn_V2a_V0v[nV0v*l+k,0]*LW_V2a_V0v[l,k] for l in range (0, nV2a))*0
                IsynR = sum(RSyn_V2a_V0v[nV0v*l+k,0]*RW_V2a_V0v[l,k] for l in range (0, nV2a))*0             
