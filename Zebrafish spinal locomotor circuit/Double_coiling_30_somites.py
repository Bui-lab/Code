...
def connectome_double_coiling(rand=0, stim0=8, sigma=0,
                                ...
                                nIC=5, nMN=30, nV2a = 30, nV0d=30, nV0v=30, nMuscle=30, weight_V0d_MN=0.3):
    ...
    L_Muscle = [ Leaky_Integrator(20.0, 10.0, dt, 5.0+1.6*i,-1) for i in range(nMuscle)]
    R_Muscle = [ Leaky_Integrator(20.0, 10.0, dt, 5.0+1.6*i,-1) for i in range(nMuscle)]
    ...
    IC_MN_gap_weight = 0.015  
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<LD_IC_MN[k,l]<30 and L_IC[k].x < L_MN[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<LD_IC_V0d[k,l]<30 and L_IC[k].x < L_V0d[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<LD_IC_V0v[k,l]<30 and L_IC[k].x < L_V0v[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<LD_IC_V2a[k,l]<30 and L_IC[k].x < L_V2a[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<RD_IC_MN[k,l]<30 and R_IC[k].x < R_MN[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<RD_IC_V0d[k,l]<30 and R_IC[k].x < R_V0d[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<RD_IC_V0v[k,l]<30 and R_IC[k].x < R_V0v[l].x):     #the second condition is because the connection is descending
    ...
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<RD_IC_V2a[k,l]<30 and R_IC[k].x < R_V2a[l].x):     #the second condition is because the connection is descending
