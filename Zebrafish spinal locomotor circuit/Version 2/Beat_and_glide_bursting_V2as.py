...
class Beat_and_glide_all_bursting_V2as(Beat_and_glide_base):
    ...
    def __init__ (self, stim0 = 2.89, sigma = 0, sigma_LR = 0.1, E_glu = 0, E_gly = -70, cv = 0.80,
        ...
        self.setWeightParameters(V2a_dI6_syn_weight = 0.75, V2a_V0v_syn_weight = 0.275, dI6_V2a_syn_weight = 2.0, V0v_V2a_syn_weight = 0.75)

    def initNeurons(self):
        super().initNeurons()
        _dt = self.getdt()
        #V0v and V2a neurons are overwritten with different parameters
        ...
        self.L_V2a = [ Izhikevich_9P(a=0.01,b=0.002,c=-55, d=2, vmax=8, vr=-60, vt=-54, k=0.3, Cm = 10, dt=_dt, x=5.1+1.6*i*gauss(1, self.sigma),y=-1) for i in range(self.nV2a)]
        self.R_V2a = [ Izhikevich_9P(a=0.01,b=0.002,c=-55, d=2, vmax=8, vr=-60, vt=-54, k=0.3, Cm = 10, dt=_dt, x=5.1+1.6*i*gauss(1, self.sigma),y=1) for i in range(self.nV2a)]
