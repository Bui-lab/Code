    ...
    for t in range (0, nmax):
        ...
        for k in range (0, nIC):
            if t < 500: #Synaptic currents are shut off for the first 50 ms of the sims to let initial conditions subside
                ...
                IsynL = sum(RSyn_V0d_IC[nIC*l+k,0]*LW_V0d_IC[l,k] for l in range (0, nV0d)) * 0  #Glygine null
                IsynR = sum(LSyn_V0d_IC[nIC*l+k,0]*RW_V0d_IC[l,k] for l in range (0, nV0d)) * 0  #Glygine null
        ...
        for k in range (0, nMN):
            if t < 500:  #Synaptic currents are shut off for the first 50 ms of the sims to let initial conditions subside
                ...
                IsynL = sum(RSyn_V0d_MN[nMN*l+k,0]*RW_V0d_MN[l,k] for l in range (0, nV0d)) * 0 #Glygine null
                IsynR = sum(LSyn_V0d_MN[nMN*l+k,0]*LW_V0d_MN[l,k] for l in range (0, nV0d)) * 0 #Glygine null
