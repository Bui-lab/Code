...
def connectome_double_coiling(rand=0, stim0=8, sigma_chem=0, sigma_gap=0,
    ...
    for k in range (0, nIC):
        for l in range (0, nIC):
            if (k!= l):                                         # because it is a kernel of ICs, there is no distance condition
                LGap_IC_IC[k,l] = IC_IC_gap_weight*gauss(1, sigma_gap) 
            else:
                LGap_IC_IC[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<LD_IC_MN[k,l]<10 and L_IC[k].x < L_MN[l].x):     #the second condition is because the connection is descending
                LGap_IC_MN[k,l] = IC_MN_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_IC_MN[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<LD_IC_V0d[k,l]<10 and L_IC[k].x < L_V0d[l].x):     #the second condition is because the connection is descending
                LGap_IC_V0d[k,l] = IC_V0d_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_IC_V0d[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<LD_IC_V0v[k,l]<10 and L_IC[k].x < L_V0v[l].x):     #the second condition is because the connection is descending
                LGap_IC_V0v[k,l] = IC_V0v_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_IC_V0v[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<LD_IC_V2a[k,l]<10 and L_IC[k].x < L_V2a[l].x):     #the second condition is because the connection is descending
                LGap_IC_V2a[k,l] = IC_V2a_gap_weight *gauss(1, sigma_gap)
            else:
                LGap_IC_V2a[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<LD_MN_MN[k,l]< 6.5 ):    
                LGap_MN_MN[k,l] = MN_MN_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_MN_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nV0d):
            if (0.2<LD_V0d_V0d[k,l]< 3.5 ):    
                LGap_V0d_V0d[k,l] = V0d_V0d_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nV0v):
        for l in range (0, nV0v):
            if (0.2<LD_V0v_V0v[k,l]< 3.5 ):    
                LGap_V0v_V0v[k,l] = V0v_V0v_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nMN):
        for l in range (0, nV0d):
            if (L_V0d[l].x-1.5 <L_MN[k].x< L_V0d[l].x + 1.5 ):    
                LGap_MN_V0d[k,l] = MN_V0d_gap_weight *gauss(1, sigma_gap) 
            else:
                LGap_MN_V0d[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nV0v):
            if (L_V0v[l].x-1.5 <L_MN[k].x< L_V0v[l].x + 1.5 ):    
                LGap_MN_V0v[k,l] = MN_V0v_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_MN_V0v[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<LD_V2a_V2a[k,l]< 3.5 ):    
                LGap_V2a_V2a[k,l] = V2a_V2a_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0.2<LD_V2a_MN[k,l]< 3.5 ):    
                LGap_V2a_MN[k,l] = V2a_MN_gap_weight*gauss(1, sigma_gap)
            else:
                LGap_V2a_MN[k,l] = 0.0    
    ...
    for k in range (0, nV0d):
        for l in range (0, nMN):
            if (0.2<LD_V0d_MN[k,l]<8.0):
                LW_V0d_MN[k,l] = V0d_MN_syn_weight*gauss(1, sigma_chem)
            else:
                LW_V0d_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nIC):
            if (0.2<LD_V0d_IC[k,l]<20.0): 
                LW_V0d_IC[k,l] = V0d_IC_syn_weight*gauss(1, sigma_chem)
            else:
                LW_V0d_IC[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nV2a):
            if (0.2<LD_V0d_V2a[k,l]<8.0):
                LW_V0d_V2a[k,l] = V0d_V2a_syn_weight*gauss(1, sigma_chem)
            else:
                LW_V0d_V2a[k,l] = 0.0
    ...
    for k in range (0, nV0v):
        for l in range (0, nIC):
            if (6.0<LD_V0v_IC[k,l]<20.0):  
                LW_V0v_IC[k,l] =  V0v_IC_syn_weight*gauss(1, sigma_chem)
            else:
                LW_V0v_IC[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0.2<LD_V2a_V0v[k,l]<10 and L_V2a[k].x < L_V0v[l].x) or (0.2<LD_V2a_V0v[k,l]<4 and L_V2a[k].x > L_V0v[l].x):    #descending and short ascending
                LW_V2a_V0v[k,l] = V2a_V0v_syn_weight*gauss(1, sigma_chem)
            else:
                LW_V2a_V0v[k,l] = 0.0    
    ...
    for k in range (0, nMN):
        for l in range (0, nMuscle):
            if (L_Muscle[l].x-1<L_MN[k].x< L_Muscle[l].x+1):         #because segments
                LW_MN_Muscle[k,l] = MN_Muscle_syn_weight*gauss(1, sigma_chem)
            else:
    ...
    for k in range (0, nIC):
        for l in range (0, nIC):
            if (k!= l):                                         # because it is a kernel of ICs, there is no distance condition
                RGap_IC_IC[k,l] = IC_IC_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_IC_IC[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<RD_IC_MN[k,l]<10 and R_IC[k].x < R_MN[l].x):     #the second condition is because the connection is descending
                RGap_IC_MN[k,l] = IC_MN_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_IC_MN[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<RD_IC_V0d[k,l]<10 and R_IC[k].x < R_V0d[l].x):     #the second condition is because the connection is descending
                RGap_IC_V0d[k,l] = IC_V0d_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_IC_V0d[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<RD_IC_V0v[k,l]<10 and R_IC[k].x < R_V0v[l].x):     #the second condition is because the connection is descending
                RGap_IC_V0v[k,l] = IC_V0v_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_IC_V0v[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<RD_IC_V2a[k,l]<10 and R_IC[k].x < R_V2a[l].x):     #the second condition is because the connection is descending
                RGap_IC_V2a[k,l] = IC_V2a_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_IC_V2a[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<RD_MN_MN[k,l]< 6.5 ):    
                RGap_MN_MN[k,l] = MN_MN_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_MN_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nV0d):
            if (0.2<RD_V0d_V0d[k,l]< 3.5 ):    
                RGap_V0d_V0d[k,l] = V0d_V0d_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nV0v):
        for l in range (0, nV0v):
            if (0.2<RD_V0v_V0v[k,l]< 3.5 ):    
                RGap_V0v_V0v[k,l] = V0v_V0v_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nMN):
        for l in range (0, nV0d):
            if (R_V0d[l].x-1.5<R_MN[k].x< R_V0d[l].x + 1.5 ):    
                RGap_MN_V0d[k,l] = MN_V0d_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_MN_V0d[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nV0v):
            if (R_V0v[l].x-1.5 <R_MN[k].x< R_V0v[l].x + 1.5 ):    
                RGap_MN_V0v[k,l] = MN_V0v_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_MN_V0v[k,l] = 0.0
    ...
    for k in range (0, nV2a):
        for l in range (0, nV2a):
            if (0.2<RD_V2a_V2a[k,l]< 3.5 ):    
                RGap_V2a_V2a[k,l] = V2a_V2a_gap_weight*gauss(1, sigma_gap)
            else:
    ...
    for k in range (0, nV2a):
        for l in range (0, nMN):
            if (0.2<RD_V2a_MN[k,l]< 3.5 ):    
                RGap_V2a_MN[k,l] =  V2a_MN_gap_weight*gauss(1, sigma_gap)
            else:
                RGap_V2a_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nMN):
            if (0.2<RD_V0d_MN[k,l]<8.0):  
                RW_V0d_MN[k,l] = V0d_MN_syn_weight*gauss(1, sigma_chem)
            else:
                RW_V0d_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nIC):
            if (0.2<LD_V0d_IC[k,l]<20.0):  
                RW_V0d_IC[k,l] = V0d_IC_syn_weight*gauss(1, sigma_chem)
            else:
                RW_V0d_IC[k,l] = 0.0     
    ...
    for k in range (0, nV0d):
        for l in range (0, nV2a):
            if (0.2<LD_V0d_V2a[k,l]<8.0):  
                RW_V0d_V2a[k,l] = V0d_V2a_syn_weight*gauss(1, sigma_chem)
            else:
                RW_V0d_V2a[k,l] = 0.0                  
    ...
    for k in range (0, nV0v):
        for l in range (0, nIC):
            if (6.0<RD_V0v_IC[k,l]<20.0):  
                RW_V0v_IC[k,l] = V0v_IC_syn_weight*gauss(1, sigma_chem)
            else:
                RW_V0v_IC[k,l] = 0.0       
    ...
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0.2<RD_V2a_V0v[k,l]<10 and R_V2a[k].x < R_V0v[l].x) or (0.2<RD_V2a_V0v[k,l]<4 and R_V2a[k].x > R_V0v[l].x):    #descending and short ascending branch
                RW_V2a_V0v[k,l] =  V2a_V0v_syn_weight*gauss(1, sigma_chem)
            else:
                RW_V2a_V0v[k,l] = 0.0   
    ...
    for k in range (0, nMN):
        for l in range (0, nMuscle):
            if (R_Muscle[l].x-1<R_MN[k].x< R_Muscle[l].x+1):         #segmental connection
                RW_MN_Muscle[k,l] = MN_Muscle_syn_weight*gauss(1, sigma_chem)
            else:
    ...
    for t in range (0, nmax):
        ...
        if not(Time[t] % 5000) and (Time[t]>20):
