...
def connectome_double_coiling(rand=0, stim0=8, sigmaD=0, sigmaL = 0, sigmaP = 0, sigmaW=0,
    ...
    tmax += 200 # add 200 ms to give time for initial conditions to dissipate.  This initial 200 ms is not used in the data analysis
    
    nmax = int(tmax/dt)
    
    ## Declare Neuron Types

    L_IC = [ Izhikevich_9P(a=0.0002*gauss(1, sigmaP),b=0.5*gauss(1, sigmaP),c=-40*gauss(1, sigmaP), d=5*gauss(1, sigmaP), vmax=0*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 50*gauss(1, sigmaP), dt=dt, x=1.0,y=-1) for i in range(nIC)]
    R_IC = [ Izhikevich_9P(a=0.0002*gauss(1, sigmaP),b=0.5*gauss(1, sigmaP),c=-40*gauss(1, sigmaP), d=5*gauss(1, sigmaP), vmax=0*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.3*gauss(1, sigmaP), Cm = 50*gauss(1, sigmaP), dt=dt, x=1.0,y=1) for i in range(nIC)]

    L_MN = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP),b=0.1*gauss(1, sigmaP),c=-50*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-50*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i,y=-1) for i in range(nMN)]
    R_MN = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP),b=0.1*gauss(1, sigmaP),c=-50*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-50*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i,y=1) for i in range(nMN)]
    
    L_V0d = [ Izhikevich_9P(a=0.02*gauss(1, sigmaP),b=0.1*gauss(1, sigmaP),c=-30*gauss(1, sigmaP), d=3.75*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i,y=-1) for i in range(nV0d)]
    R_V0d = [ Izhikevich_9P(a=0.02*gauss(1, sigmaP),b=0.1*gauss(1, sigmaP),c=-30*gauss(1, sigmaP), d=3.75*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.0+1.6*i,y=1) for i in range(nV0d)]
    
    L_V0v = [ Izhikevich_9P(a=0.02*gauss(1, sigmaP), b=0.1*gauss(1, sigmaP), c=-30*gauss(1, sigmaP), d=11.6*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i,y=-1) for i in range(nV0v)]
    R_V0v = [ Izhikevich_9P(a=0.02*gauss(1, sigmaP), b=0.1*gauss(1, sigmaP), c=-30*gauss(1, sigmaP), d=11.6*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i,y=1) for i in range(nV0v)]
    
    L_V2a = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP), b=0.1*gauss(1, sigmaP), c=-50*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i,y=-1) for i in range(nV2a)]
    R_V2a = [ Izhikevich_9P(a=0.5*gauss(1, sigmaP), b=0.1*gauss(1, sigmaP), c=-50*gauss(1, sigmaP), d=100*gauss(1, sigmaP), vmax=10*gauss(1, sigmaP), vr=-60*gauss(1, sigmaP), vt=-45*gauss(1, sigmaP), k=0.05*gauss(1, sigmaP), Cm = 20*gauss(1, sigmaP), dt=dt, x=5.1+1.6*i,y=1) for i in range(nV2a)]
    
    L_Muscle = [ Leaky_Integrator(50.0*gauss(1, sigmaP), 5.0*gauss(1, sigmaP), dt, 5.0+1.6*i,-1) for i in range(nMuscle)]
    R_Muscle = [ Leaky_Integrator(50.0*gauss(1, sigmaP), 5.0*gauss(1, sigmaP), dt, 5.0+1.6*i,-1) for i in range(nMuscle)]
    ...
    #List of residual for solving for membrane potential
    resLIC=zeros((nIC,3))
    resRIC=zeros((nIC,3))
    resLMN=zeros((nMN,3))
    resRMN=zeros((nMN,3))
    ...
    for k in range (0, nIC):
        for l in range (0, nIC):
            if (k!= l):                                         # because it is a kernel of ICs, there is no distance condition
                LGap_IC_IC[k,l] = IC_IC_gap_weight*gauss(1, sigmaW) 
            else:
                LGap_IC_IC[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<LD_IC_MN[k,l]<10*gauss(1, sigmaL) and L_IC[k].x < L_MN[l].x):     #the second condition is because the connection is descending
                LGap_IC_MN[k,l] = IC_MN_gap_weight*gauss(1, sigmaW)
            else:
                LGap_IC_MN[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<LD_IC_V0d[k,l]<10*gauss(1, sigmaL) and L_IC[k].x < L_V0d[l].x):     #the second condition is because the connection is descending
                LGap_IC_V0d[k,l] = IC_V0d_gap_weight*gauss(1, sigmaW)
            else:
                LGap_IC_V0d[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<LD_IC_V0v[k,l]<10*gauss(1, sigmaL) and L_IC[k].x < L_V0v[l].x):     #the second condition is because the connection is descending
                LGap_IC_V0v[k,l] = IC_V0v_gap_weight*gauss(1, sigmaW)
            else:
                LGap_IC_V0v[k,l] = 0.0
    ...
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<LD_IC_V2a[k,l]<10*gauss(1, sigmaL) and L_IC[k].x < L_V2a[l].x):     #the second condition is because the connection is descending
                LGap_IC_V2a[k,l] = IC_V2a_gap_weight *gauss(1, sigmaW)
            else:
                LGap_IC_V2a[k,l] = 0.0
    ...
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<LD_MN_MN[k,l]< 6.5*gauss(1, sigmaL) ):    
    ...
    for k in range (0, nV0d):
        for l in range (0, nV0d):
            if (0.2<LD_V0d_V0d[k,l]< 3.5*gauss(1, sigmaL) ):    
                LGap_V0d_V0d[k,l] = V0d_V0d_gap_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nMN):
        for l in range (0, nV0d):
            if (L_V0d[l].x-1.5*gauss(1, sigmaL) <L_MN[k].x< L_V0d[l].x + 1.5 *gauss(1, sigmaL)):    
                LGap_MN_V0d[k,l] = MN_V0d_gap_weight *gauss(1, sigmaW) 
            else:
                LGap_MN_V0d[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nMN):
            if (0.2<LD_V0d_MN[k,l]<8.0*gauss(1, sigmaL)):
                LW_V0d_MN[k,l] = V0d_MN_syn_weight*gauss(1, sigmaW)
            else:
                LW_V0d_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nIC):
            if (0.2<LD_V0d_IC[k,l]<20.0*gauss(1, sigmaL)): 
                LW_V0d_IC[k,l] = V0d_IC_syn_weight*gauss(1, sigmaW)
            else:
                LW_V0d_IC[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nV2a):
            if (0.2<LD_V0d_V2a[k,l]<8.0*gauss(1, sigmaL)):
                LW_V0d_V2a[k,l] = V0d_V2a_syn_weight*gauss(1, sigmaW)
            else:
                LW_V0d_V2a[k,l] = 0.0
                
    V0v_IC_syn_weight = 0.175 
    for k in range (0, nV0v):
        for l in range (0, nIC):
            if (6.0<LD_V0v_IC[k,l]<20.0*gauss(1, sigmaL)):  
                LW_V0v_IC[k,l] =  V0v_IC_syn_weight*gauss(1, sigmaW)
            else:
                LW_V0v_IC[k,l] = 0.0
    
    V2a_V0v_syn_weight = 0.04          
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0.2<LD_V2a_V0v[k,l]<10*gauss(1, sigmaL) and L_V2a[k].x < L_V0v[l].x) or (0.2<LD_V2a_V0v[k,l]<4*gauss(1, sigmaL) and L_V2a[k].x > L_V0v[l].x):    #descending and short ascending
    ...
    for k in range (0, nMN):
        for l in range (0, nMuscle):
            if (L_Muscle[l].x-1<L_MN[k].x< L_Muscle[l].x+1):         #segmental connection
                LW_MN_Muscle[k,l] = MN_Muscle_syn_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nIC):
        for l in range (0, nIC):
            if (k!= l):                                         # because it is a kernel of ICs, there is no distance condition
                RGap_IC_IC[k,l] = IC_IC_gap_weight*gauss(1, sigmaW)
            else:
                RGap_IC_IC[k,l] = 0.0
                
    for k in range (0, nIC):
        for l in range (0, nMN):
            if (0.2<RD_IC_MN[k,l]<10*gauss(1, sigmaL) and R_IC[k].x < R_MN[l].x):     #the second condition is because the connection is descending
                RGap_IC_MN[k,l] = IC_MN_gap_weight*gauss(1, sigmaW)
            else:
                RGap_IC_MN[k,l] = 0.0
                
    for k in range (0, nIC):
        for l in range (0, nV0d):
            if (0.2<RD_IC_V0d[k,l]<10*gauss(1, sigmaL) and R_IC[k].x < R_V0d[l].x):     #the second condition is because the connection is descending
                RGap_IC_V0d[k,l] = IC_V0d_gap_weight*gauss(1, sigmaW)
            else:
                RGap_IC_V0d[k,l] = 0.0
                
    for k in range (0, nIC):
        for l in range (0, nV0v):
            if (0.2<RD_IC_V0v[k,l]<10*gauss(1, sigmaL) and R_IC[k].x < R_V0v[l].x):     #the second condition is because the connection is descending
                RGap_IC_V0v[k,l] = IC_V0v_gap_weight*gauss(1, sigmaW)
            else:
                RGap_IC_V0v[k,l] = 0.0
                               
    for k in range (0, nIC):
        for l in range (0, nV2a):
            if (0.2<RD_IC_V2a[k,l]<10*gauss(1, sigmaL) and R_IC[k].x < R_V2a[l].x):     #the second condition is because the connection is descending
                RGap_IC_V2a[k,l] = IC_V2a_gap_weight*gauss(1, sigmaW)
            else:
                RGap_IC_V2a[k,l] = 0.0
                
    for k in range (0, nMN):
        for l in range (0, nMN):
            if (0.2<RD_MN_MN[k,l]< 6.5*gauss(1, sigmaL) ):    
    ...
    for k in range (0, nV0d):
        for l in range (0, nV0d):
            if (0.2<RD_V0d_V0d[k,l]< 3.5*gauss(1, sigmaL) ):    
                RGap_V0d_V0d[k,l] = V0d_V0d_gap_weight*gauss(1, sigmaW)
            else:
    ...
    for k in range (0, nMN):
        for l in range (0, nV0d):
            if (R_V0d[l].x-1.5*gauss(1, sigmaL)<R_MN[k].x< R_V0d[l].x + 1.5*gauss(1, sigmaL) ):    
                RGap_MN_V0d[k,l] = MN_V0d_gap_weight*gauss(1, sigmaW)
            else:
                RGap_MN_V0d[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nMN):
            if (0.2<RD_V0d_MN[k,l]<8.0*gauss(1, sigmaL)):  
                RW_V0d_MN[k,l] = V0d_MN_syn_weight*gauss(1, sigmaW)
            else:
                RW_V0d_MN[k,l] = 0.0
    ...
    for k in range (0, nV0d):
        for l in range (0, nIC):
            if (0.2<LD_V0d_IC[k,l]<20.0*gauss(1, sigmaL)):  
                RW_V0d_IC[k,l] = V0d_IC_syn_weight*gauss(1, sigmaW)
            else:
                RW_V0d_IC[k,l] = 0.0     
    ...
    for k in range (0, nV0d):
        for l in range (0, nV2a):
            if (0.2<LD_V0d_V2a[k,l]<8.0*gauss(1, sigmaL)):  
                RW_V0d_V2a[k,l] = V0d_V2a_syn_weight*gauss(1, sigmaW)
            else:
                RW_V0d_V2a[k,l] = 0.0                  
                
    for k in range (0, nV0v):
        for l in range (0, nIC):
            if (6.0<RD_V0v_IC[k,l]<20.0*gauss(1, sigmaL)):  
                RW_V0v_IC[k,l] = V0v_IC_syn_weight*gauss(1, sigmaW)
            else:
                RW_V0v_IC[k,l] = 0.0       
    
    for k in range (0, nV2a):
        for l in range (0, nV0v):
            if (0.2<RD_V2a_V0v[k,l]<10*gauss(1, sigmaL) and R_V2a[k].x < R_V0v[l].x) or (0.2<RD_V2a_V0v[k,l]<4*gauss(1, sigmaL) and R_V2a[k].x > R_V0v[l].x):    #descending and short ascending branch
